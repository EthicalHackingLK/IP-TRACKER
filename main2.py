...
if connect():
    Write.Print("Connecting.......",Colors.red_to_purple, interval=0.09)
    os.system("clear")
    Write.Print("Connecting.......",Colors.red_to_purple, interval=0.09)
    os.system("clear")
    Write.Print("Connecting.......",Colors.red_to_purple, interval=0.09)
    ...
    Write.Print("Connecting.......",Colors.red_to_purple, interval=0.09)
    os.system("clear")
    Write.Print("Connected\n",Colors.red_to_purple, interval=0.09)
    
else:
    Write.Print("No Internet !!!!!!!!!",Colors.red_to_purple, interval=0.09)
    os.system("clear")
    Write.Print("No Internet !!!!!!!!!",Colors.red_to_purple, interval=0.09)
    os.system("clear")
    Write.Print("No Internet !!!!!!!!!",Colors.red_to_purple, interval=0.09)
    ...
    Write.Print("No Internet !!!!!!!!!",Colors.red_to_purple, interval=0.09)
    time.sleep(5)
    Write.Print("\nPlese Connect The Internet",Colors.red_to_purple, interval=0.09)
...
def menu():
    ...
    lk=int(input(W+"\n\n[\033[01;31m+\033[39m]\033[32m IP-TRACKER"+E+" >>  "))
    if(lk==1):
        ip_track() 
    elif(lk==2):
        my_ip()
